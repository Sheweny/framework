...
export default class PingCommand extends Command {
  ...
  execute(interaction: CommandInteraction) {
    ...
    row.addComponents([
      ...
      new ButtonBuilder().setCustomId('sheweny-a').setLabel('Button (not work)').setStyle(ButtonStyle.Danger),
      new ButtonBuilder().setCustomId('sheweny-ab').setLabel('Button (not work)').setStyle(ButtonStyle.Danger),
    ]);
